...
# TODO: switch to https://github.com/cloudposse/terraform-aws-ecs-container-definition
# when https://github.com/cloudposse/terraform-aws-ecs-container-definition/pull/37 will be merged

module "traefik_container_definition" {
  source                       = "git::https://github.com/aleks-fofanov/terraform-aws-ecs-container-definition?ref=master"
